    ...
    <div class="container">
      ...
      <div class="cards">
        <div class="card section-card">
          ...
          <a class="btn btn--brand" href="<?= e($fundData['links']['multisig_explorer']) ?>" target="_blank" rel="noopener"><?= e($t['council']['links']['multisig']['cta']) ?></a>
        </div>
        <div class="card section-card">
          <h3><?= e($t['council']['links']['charter']['title']) ?></h3>
          <p><?= e($t['council']['links']['charter']['body']) ?></p>
          <a class="btn btn--brand" href="<?= e($fundData['links']['charter']) ?>" target="_blank" rel="noopener"><?= e($t['council']['links']['charter']['cta']) ?></a>
        </div>
      </div>
    </div>
  </section>
